				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="#" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							<div class="alert alert-success" role="alert">Seu cadastro foi criado!</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="re-password" class="sr-only">Repetir a senha</label>
							<input type="password" class="form-control" id="re-password" placeholder="Re-type Password" autocomplete="off">
						</div>
						
						<div class="form-group">
							<p>Já tem registro <a href="login.php">Login</a></p>
						</div>
						<div class="form-group">
